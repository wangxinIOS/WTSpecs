...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wangxinIOS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sybz' => 'wangxin19891226@hotmail.com' }
  s.source           = { :git => 'https://github.com/wangxinIOS/podTestLibrary.git', :tag => s.version.to_s }
